...
class HomeBookCard extends StatefulWidget {
  const HomeBookCard({super.key});

  @override
  State<HomeBookCard> createState() => _HomeBookCardState();
}

class _HomeBookCardState extends State<HomeBookCard> {
